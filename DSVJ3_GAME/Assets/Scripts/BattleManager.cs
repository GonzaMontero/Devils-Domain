...
public class BattleManager : MonoBehaviour
{
    ...
    Tile[] characterTiles = new Tile[12]; //second 6 are enemies (same as player)
    ...
    {
        int receiverNumber = attacker.slotNumber;
        receiverNumber += attacker.slotNumber >= 6 ? -6 : 6; //get parallel
